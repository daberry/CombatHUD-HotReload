...
namespace CombatHUD_HotReload
{
    [FriendlyName("CombatHUD_HotReload")]
    public class CombatHUD_HotReload : FilterBase
    {
        ...
        /// </summary>
        public static string PluginAssemblyNamespace { get { return "CombatHUD_HotReloadPlugin.CombatHUD_HotReloadPlugin"; } }

        /// <summary>
        /// File name of the plugin we want to hot reload
        /// </summary>
        public static string PluginAssemblyName { get { return "CombatHUD_HotReloadPlugin.dll"; } }
        ...
        public static string PluginAssemblyDirectory
        {
            get
            {
                return System.IO.Path.GetDirectoryName(Assembly.GetAssembly(typeof(CombatHUD_HotReload)).Location);
            }
        }
